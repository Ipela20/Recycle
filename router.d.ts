...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/explore` | `/screens/HomeScreen` | `/screens/LoginScreen` | `/screens/MapScreen` | `/screens/ProfileScreen` | `/screens/RewardsScreen` | `/screens/SortingInfoScreen` | `/types`;
